...
public class Incializar_Tablas {
    ...
    private void creacionDeTablasEnBD(Connection connection) throws SQLException {
        ...
        sql = "CREATE TABLE IF NOT EXISTS USUARIO (" +
                ...
                "PELICULAS_RESENADAS TEXT," +
                "PRIMER_ACCESO INTEGER DEFAULT 1 NOT NULL," +
                "CONSTRAINT USUARIO_DATOS_PERSONALES_FK " +
                "FOREIGN KEY (DNI_PERSONA) REFERENCES DATOS_PERSONALES(DNI)" +
                ");";
        stmt.executeUpdate(sql);
